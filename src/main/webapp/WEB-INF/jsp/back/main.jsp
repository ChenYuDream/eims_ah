    ...
    <div class="layui-header">
        <div class="layui-main">
            ...
            <a href="${config.webUrl}">
                <c:if test="${empty config.logoUrl}">
                    <img src="${ctx}/static/back/images/logo.png" alt="">
                </c:if>
                <c:if test="${not empty config.logoUrl}">
                    <img src="${baseInfo.fileServerPath}${config.logoUrl}">
                </c:if>
            </a>
            <!-- 水平导航 -->
            <ul class="layui-nav" style="position: absolute; top: 0; right: 0; background: none;">
                <li class="layui-nav-item">
                    <a href="${config.webUrl}" target="_blank">访问官网</a>
                </li>
                <li class="layui-nav-item">
                    <a href="javascript:;">
                        admin
