...
<table class="layui-table">
    ...
    <tr ms-repeat="tableData" align="center">
        ...
        <td align="left">{{el.subContent}}</td>
...
<div class="layui-form">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline" style="width: 70%">
            <input type="text" name="subContent" ms-duplex="news.subContent" placeholder="请输入摘要" lay-verify="required"
                   class="layui-input">
        </div>
    </div>
...
<script type="text/javascript">
    ...
    var vm = {
        ...
        tableData: [],
        news: {id: '', title: '',subContent:'', showImgs: '', contentText: '', contentType: '${navContent.tag}', sortOrder: 0},
        bakNews: {id: '', title: '', subContent:'',showImgs: '', contentText: '', contentType: '${navContent.tag}', sortOrder: 0},
        addData: function () {
            um.setContent('');
        ...
        loadTableData: function () {
            ajaxUtil.post("${ctx}/news/list/page/${navContent.tag}", vm.$model.page, false, function (data) {
                console.log(data);
                vm.tableData = data.data.result;
                vm.page.totalRows=data.data.totalRows;
                pageUtil.renderPage(vm.page,vm.loadTableData,"demo");
            })
        },
